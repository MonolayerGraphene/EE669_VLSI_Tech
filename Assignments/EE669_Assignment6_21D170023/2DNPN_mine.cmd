...
line x loc= -2.0<um>
line x loc= 0.0<um>
line x loc= 2.0<um> tag=SubTop
line x loc= 2.5<um>
line x loc= 3.0<um> 
line x loc= 3.5<um>
line x loc= 4.0<um>  tag=SubBottom
...
init concentration=1.23e+15<cm-3> field=Boron
...
implant Antimony dose=1.53e15<cm-2> energy=100<keV>
...
implant Arsenic dose=5.23e15<cm-2> energy=55<keV> tilt=7 rotation=0
strip Resist
diffuse temp=1100<C> time=25<min> maxstep=4<min>

struct tdr=Emmiter_complete
...
etch material= {Aluminum} type=anisotropic time=1 rate= {1.0} mask=Metal

struct tdr=Final_device
